            ...
            <div className="container">
                    ...
                    <div className="col-md-2">
                        <a href="#" className="thumbnail">
                            <img className="mod-logo"
                                 src={`${globals.publicFolder()}/projects/logo/${this.state.projectData.logo}`}/>
                        </a>
                    </div>
                ...
                <div className="row">
                    <div className="col-md-10">
                        <p dangerouslySetInnerHTML={{ __html: this.state.projectData.description ? globals.parseMarkdown(this.state.projectData.description) : '' }}/>
                    </div>
                </div>
            </div>
        );
